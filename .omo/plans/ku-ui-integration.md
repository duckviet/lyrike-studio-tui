...
- [x] 6. Implement overlay enum and `overlayCenter`/`overlayBlock`
...
- [x] 8. Port fuzzy ranking algorithm
...
- [x] 9. Port reusable fuzzy selector component
...
- [x] 10. Replace project picker with fuzzy selector overlay
...
- [x] 11. Port generic confirm dialog
...
- [x] 12. Convert dirty-replace prompts to confirm overlay
...
- [x] 13. Convert fetch input to centered input overlay
